...
# gfwlist4phicomm.sh
#
# Update the gfwlist for an Phicomm router with unofficial ROM.
#
# Fork from https://github.com/cokebar/gfwlist2dnsmasq
# Modified by Neil Steven
#
# Update on 2018-04-06 09:00
...
process(){
    ...
    curl -s -L -k -o $BASE64_FILE $BASE_URL
    if [ $? != 0 ]; then
        printf '\nFailed to fetch gfwlist. Please check your Internet connection.\n'
        clean_and_exit 2
    fi
    ...
    printf 'twimg.edgesuite.net... Added\n'
    ...
    echo '# https://github.com/Neil-Steven/gfwlist4phicomm' >> $OUT_TMP_FILE
